          ...
          >
            <div className="p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {!isSignUp && (
                  <div className="text-right">
                    <button type="button" className="text-sm font-medium text-primary-500 hover:text-primary-400">
                      Forgot Password?
                    </button>
                  </div>
                )}
              ...
              <div className="grid grid-cols-2 gap-4">
                <button className="flex items-center justify-center py-3 px-4 bg-slate-950 border border-slate-800 rounded-xl hover:bg-slate-800 transition-colors text-white font-medium">
